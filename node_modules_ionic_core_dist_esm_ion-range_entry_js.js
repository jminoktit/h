"use strict";
(self["webpackChunkMohassil"] = self["webpackChunkMohassil"] || []).push([["node_modules_ionic_core_dist_esm_ion-range_entry_js"],{
...
/* harmony import */ var _index_e6d1a8be_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-e6d1a8be.js */ 24311);
...
/* harmony import */ var _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./dir-e8b767a8.js */ 17481);
...
var Range = /*#__PURE__*/function () {
  function Range(hostRef) {
    ...
    (0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Range);
    ...
    this.ionKnobMoveStart = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_5__.e)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_5__.e)(this, "ionKnobMoveEnd", 7);
    this.didLoad = false;
    this.noUpdate = false;
    this.hasFocus = false;
    ...
    this.clampBounds = function (value) {
      return (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(_this.min, value, _this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_regenerator_index_js__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee() {
      var rangeSlider;
    ...
    this.handleKeyboard = function (knob, isIncrease) {
      ...
      if (knob === 'A') {
        _this.ratioA = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(0, _this.ratioA + step, 1);
      } else {
        _this.ratioB = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(0, _this.ratioB + step, 1);
      }
  ...
  (0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_3__["default"])(Range, [{
    key: "debounceChanged",
    value: function debounceChanged() {
      this.ionChange = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.h)(this.ionChange, this.debounce);
    }
  }, {
    key: "minChanged",
    ...
    value: function activeBarStartChanged() {
      ...
      if (activeBarStart !== undefined) {
        if (activeBarStart > this.max) {
          (0,_index_c4b11676_js__WEBPACK_IMPORTED_MODULE_9__.p)("Range: The value of activeBarStart (".concat(activeBarStart, ") is greater than the max (").concat(this.max, "). Valid values are greater than or equal to the min value and less than or equal to the max value."), this.el);
          this.activeBarStart = this.max;
        } else if (activeBarStart < this.min) {
          (0,_index_c4b11676_js__WEBPACK_IMPORTED_MODULE_9__.p)("Range: The value of activeBarStart (".concat(activeBarStart, ") is less than the min (").concat(this.min, "). Valid values are greater than or equal to the min value and less than or equal to the max value."), this.el);
    ...
    value: function connectedCallback() {
      ...
      this.contentEl = (0,_index_e6d1a8be_js__WEBPACK_IMPORTED_MODULE_7__.f)(this.el);
    }
  }, {
    ...
    value: function onStart(detail) {
      ...
      if (contentEl) {
        this.initialContentScrollY = (0,_index_e6d1a8be_js__WEBPACK_IMPORTED_MODULE_7__.d)(contentEl);
      }
      ...
      var ratio = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(0, (currentX - rect.left) / rect.width, 1);

      if ((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_10__.i)(this.el)) {
        ratio = 1 - ratio;
      }
    ...
    value: function onEnd(detail) {
      ...
      if (contentEl) {
        (0,_index_e6d1a8be_js__WEBPACK_IMPORTED_MODULE_7__.r)(contentEl, initialContentScrollY);
      }
    ...
    value: function render() {
      ...
      var _getAriaLabel = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.d)(el, rangeId),
      ...
      var rtl = (0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_10__.i)(this.el);
      var start = rtl ? 'right' : 'left';
      var end = rtl ? 'left' : 'right';

      var tickStyle = function tickStyle(tick) {
        return (0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, start, tick[start]);
      };
      ...
      var barStyle = (_barStyle = {}, (0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_barStyle, start, barStart), (0,C_Users_Fady_Desktop_Tasks_Delete_it_NewMohassilClient_3095_src_NewMohassilClient_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_barStyle, end, barEnd), _barStyle);
      var ticks = [];
...
var renderKnob = function renderKnob(rtl, _ref3) {
  ...
  return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_5__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_5__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_5__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
var ratioToValue = function ratioToValue(ratio, min, max, step) {
  ...
  return (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(min, value, max);
};

var valueToRatio = function valueToRatio(value, min, max) {
  return (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_8__.l)(0, (value - min) / (max - min), 1);
};
